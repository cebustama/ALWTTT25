namespace Vocal {
    ...
    internal class Noise {
        internal static Func<float> CreateFilteredNoiseSource(double f0, double q, int sampleRate, int bufferSize, IRandomSource random) {
        ...
        static Func<double> CreateBufferedWhiteNoiseSource(int bufferSize, IRandomSource random) {
