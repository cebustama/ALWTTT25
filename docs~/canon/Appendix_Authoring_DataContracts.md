# ALWTTT — Appendix — Authoring & Data Contracts (v0.2)

**STATUS:** CANONICAL APPENDIX (non-gameplay)
**SCOPE:** Editor authoring workflow + JSON/import contracts + status identity (statusKey/catalogue). Does NOT define combat runtime semantics.
...
- This appendix is **normative** for: how card effects are **represented**, **serialized**, and **authored/imported**.
- This appendix is **not** the source of truth for: how combat should feel, timing rules, loop/song flow, balance, or any runtime-only rule.
- Runtime semantics live in: **SSoT — Gig Combat Card-Effects Pipeline**.
