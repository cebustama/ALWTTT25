...
| `planning/active/Design_Tutorial_System_v0_3.md` | tutorial system: scope, trigger model, presentation, UX, S4 reactive inventory (historical) + gig-1 guided curriculum (TUT-REBUILD, §6B, record) + **gig-1 arc for the band of 4 (TUT-REDESIGN-A/B, §6C, current)**, decision ledger, DoD per Standing Directive #3 | active (single tutorial home; v0_1 archived 2026-08-08, D11=A; **v0_2 → v0_3 by rename 2026-09-04, DOC-TUTR-B, D-TUTR-6=B** — same path folder, same class; no v0_2 file remains) |
...
| `planning/archive/Design_Tutorial_System_v0_1.md` | tutorial system, S4-era reactive design (created 2026-05-23; §6 standalone dialog list + §6A jam sequence) | superseded / archived 2026-08-08 (D11=A) | `planning/active/Design_Tutorial_System_v0_3.md` (was v0_2 until 2026-09-04; absorbs it whole, incl. the D-TUT-6..11 ledger) |
