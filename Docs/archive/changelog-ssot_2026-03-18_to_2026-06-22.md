ARCHIVED — changelog history segment; superseded by the rotated active changelog-ssot.md on 2026-07-01.
Reason: log rotation (D-DOC-ROTATE=C). Verbatim full history 2026-03-18 → 2026-06-22 (Governance migration Batch 01 → S5a).
Authority: Historical only. The active changelog-ssot.md carries a milestone index pointing here.
